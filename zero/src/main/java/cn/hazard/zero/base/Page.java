...
import cn.hazard.tools.CookieUtils;
...
public class Page<T> extends BaseObject {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4522460033772624807L;
	private int pageNo = 1; // 当前页码
	private int pageSize = 10;//Integer.valueOf(Global.getConfig("page.pageSize")); // 页面大小，设置为�?-1”表示不进行分页（分页无效）
	
	private int startRow;//起始�?(闭合)
	private int endRow;//终止�?(闭合)
	...
	public Page(int pageNo, int pageSize, long count, List<T> list) {
		...
		this.list = list;
		this.setStartRow((pageNo-1)*pageSize+1);
		this.setEndRow(pageNo*pageSize);
	}
	...
	public String toString() {
		...
		if (pageNo == first) {// 如果是首�?
			sb.append("<li class=\"disabled\"><a href=\"javascript:\">&#171; 上一�?</a></li>\n");
		} else {
			sb.append("<li><a href=\"javascript:\" onclick=\""+funcName+"("+prev+","+pageSize+",'"+funcParam+"');\">&#171; 上一�?</a></li>\n");
		}
		...
		if (pageNo == last) {
			sb.append("<li class=\"disabled\"><a href=\"javascript:\">下一�? &#187;</a></li>\n");
		} else {
